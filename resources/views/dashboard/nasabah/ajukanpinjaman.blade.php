...
<section class="section dashboard">
    <div class="card">
        <div class="card-body p-5">
            ...
            <form class="row g-3" action="/ajukanpinjaman" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-12">
                    <div class="form-floating">
                        <textarea class="form-control @error('tujuan_pinjaman') is-invalid @enderror" name="tujuan_pinjaman" id="tujuan_pinjaman" style="height: 100px;" required></textarea>
